...
return(
    <section id='teachers' className='teachers-section'>
        ...
        <div className='teachers-item'>
            ...
            <img className='teachers1-img' src="./images/teachers1.jpg" alt="" />
        ...
        <div className='teachers-item'>
            ...
            <img className='teachers2-img' src="./images/teachers2.jpg" alt="" />
            <div className='teachers-item-overlay'></div></a>
        </div>
        ...
        <div className='teachers-item'>
            ...
            <img src="./images/teachers3.jpg" alt="" />
            <div className='teachers-item-overlay'></div></a>
        </div>
        <div className='teachers-item'>
            <a href="">
            ...
            <img src="./images/teachers4.jpg" alt="" />
            <div className='teachers-item-overlay'></div></a>
        </div>
        <div className='teachers-item'>
            <a href="">
            ...
            <img src="./images/teachers5.jpg" alt="" />
            <div className='teachers-item-overlay'></div></a>
        </div>
        <div className='teachers-item'>
            <a href="">
            ...
            <img src="./images/teachers6.jpg" alt="" />
            <div className='teachers-item-overlay'></div></a>
        </div>
        <div className='teachers-item'>
            <a href="">
            ...
            <img src="./images/teachers7.jpg" alt="" />
            <div className='teachers-item-overlay'></div></a>
        </div>
        <div className='teachers-item'>
            <a href="">
            ...
            <img src="./images/teachers8.jpg" alt="" />
            <div className='teachers-item-overlay'></div></a>
        </div>
        <div className='teachers-item'>
            <a href="">
            ...
            <img src="./images/teachers9.jpg" alt="" />
            <div className='teachers-item-overlay'></div></a>
        </div>
        <div className='teachers-item'>
            <a href="">
            ...
            <img src="./images/teachers10.jpg" alt="" />
            <div className='teachers-item-overlay'></div></a>
        </div>
